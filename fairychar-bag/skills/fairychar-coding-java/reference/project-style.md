...
- 应用层样例：本 skill 的 `sample/controller`、`sample/service`、`sample/service/interfaces`。
...
- 应用 Controller：`sample/controller/PermissionPolicyController.java`
- 应用 Service：`sample/service/PermissionPolicyService.java`
- 应用 Service 接口：`sample/service/interfaces/IPermissionPolicyService.java`
